    ...
    <div :class="[prefixCls, 'clearfix']" :style="{minHeight:iPageTableDataListHeight + 'px'}">
        ...
        <slot name="page-search">
            ...
            <template v-if="hasHeightSearch">
                <template v-if="queryCondition.length>0 || customSearchCondition.length>0">
                    <newHeightSearch
                        ref="highSearch"
                        :isFetchFuzzySearch="isFetchFuzzySearch"
                        :datePickDefault="datePickDefault"
                        :infoSetId="infoSetId"
                        :customSearchCondition="customSearchCondition"
                        :queryCondition="queryCondition"
                        :columnEdit="columnEdit"
                        :resulNum="searchResultSum"
                        :btns="defineBtns"
                ...
                <template v-else>
                    <slot name="page-btn-group">
                        <div class="hs-head" style="margin-bottom:10px">
...
import newHeightSearch from 'commonVueLib/newHeightSearch'; //高级搜索
    ...
    export default {
        ...
        ,data:function () {
            ...
            return {
                ...
                ,tableData: {} //表体数据,
                ,oQueryData:{"pageBean":{"pageNo":"1","pageSize":20}, "navigationCondition":null}
                ...
                t.$daydao.$ajax({
                    ...
                    ,success:function (data) {
                        if(data.result == "true"){
                            ...
                            t.customSearchCondition = data.customSearchCondition;
                            t.queryCondition = data.searchCondition;

                            t.columnEdit = data.columnEdit;
                            ...
                            // 没有高级搜索的话 , 直接搜索
                            if (!t.customSearchCondition && !t.queryCondition) {
                                t.getTableData();
                                setTimeout(function () {
                                    t.$refs.tableList && t.$refs.tableList.setTableHeight();
                                },100);
                            }
                            t.$emit('after-get-table-column');
            ...
            ,getTableData:function (data) {
                ...
                t.$daydao.$ajax({
                    ...
                    ,success:function (data) {
                        if(data.result == "true"){
                            t.tableData = data || {};
                            t.searchResultSum = t.tableData.pb.pageDataCount;
