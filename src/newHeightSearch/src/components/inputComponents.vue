        ...
        methods: {
            ...
            defaultDataHandler() {
                ...
                this.conditionList.forEach((condition,index)=>{
                    ...
                    let item = JSON.parse(JSON.stringify(condition));
            ...
            setValue({value} , condition){
                if (condition.conditionId) {
                    let flag = this.conditionList.findIndex(item=>item.conditionId === condition.conditionId);
                    if (condition.cellTypeId === '9' || condition.cellTypeId === 'originTree') {
                        this.$set(this.modelArr , flag , [value]);
                    }else{
                        this.$set(this.modelList ,flag ,value);
                    }
                }
            }
        }
