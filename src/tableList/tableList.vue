    ...
    <div :class="[prefixCls + '_list','clearfix']">
        ...
        <div :class="[prefixCls + '_list_width_data','clearfix']" v-show="myTableData.length">
            ...
            <div :class="[prefixCls + '_hide_column']" title="设置表头字段" @click="showTableHideColumnTool" :style="{height:iHideColumnHeight + 'px'}" v-if="!isShowTableHideColumnTool">
                <div class="show_column_btn iconfont_daydao_common">&#xe644;</div>
            </div>
...
<script>
    ...
    export default{
        ...
        ,mounted () {
            ...
            //窗口变化 ，只有在tableDataList中调用的这个表格组件才自动计算高度
        ...
        ,methods:{
            ...
            ,setTableHeight(){
                ...
                if(document.querySelector('.'+t.prefixCls+'_list')){
                    var rectY = $('.'+t.prefixCls+'_list').offset().top;
                    t.myTableHeight = $(window).height()- rectY - 68;
                }
            }
            /**
             * 设置隐藏列高度
