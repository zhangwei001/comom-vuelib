            ...
            <div class="cloud-file-item" @click="clickItem(index)" :class="{opacityFile: opacityFile && item.fileType == fileType.file}">
                <div class="check-box" >
                    <template v-if="item.disabled">
                        <Tooltip content="无权限选取该文件" placement="top-start">
                            <Checkbox v-if="checkbox" v-show="item.fileType == fileType.file" :disabled="item.disabled"></Checkbox>
                        </Tooltip>
                    </template>
                    <template v-else>
                        <Checkbox v-if="checkbox" v-show="item.fileType == fileType.file" :value="item.checked"></Checkbox>
                    </template>
                </div>
                <div class="info">
